    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header">
            <a href="<?php echo base_url();?>user" class="brand-logo">
                ...
                <div class="tab-pane chart-sidebar fade show active" role="tabpanel">
                    <div class="card">
                        <div class="card-header align-items-start">
                            <div>
                                <h6>Daily Sales</h6>
                                <p>Daily Analysis for Trade n-max report</p>
                            </div>
                    ...
                    <div class="card bg-warning-light">
                        <div class="card-header align-items-start mb-3">
                            <div>
                                <h6>Profit Share</h6>
                                <p>Monthly Analysis for Trade n-max report</p>
                            </div>
                            ...
                            <li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell dz-fullscreen" href="#">
                                    <svg id="icon-full" viewBox="0 0 24 24" width="20" height="20" stroke="currentColor"
                                        ...
                                        class="<?php echo base_url()?>/assets/css-i6dzq1">
                                        <path
        ...
        <div class="deznav">
            ...
            <a href="<?php echo base_url()?>user/login" class="logout-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
