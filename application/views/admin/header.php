    ...
    <div id="main-wrapper">
                ...
                <div class="tab-pane chart-sidebar fade show active" role="tabpanel">
                    ...
                    <div class="card bg-warning-light">
                        <div class="card-header align-items-start mb-3">
                            <div>
                                <h6>All users Details</h6>
                                <p>All users for Trade n-max report</p>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="chart-point">
                                ...
                                <ul class="chart-point-list">
                                    <li><i class="fa fa-circle text-primary mr-1"></i> 233 Users</li>
        ...
        <div class="deznav">
            ...
            <a href="<?php echo base_url()?>admin/login" class="logout-btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
