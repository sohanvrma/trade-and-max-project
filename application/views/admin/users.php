                                        ...
                                        <table class="table table-responsive-sm mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="recent-stats d-flex align-items-center"><i class="fa fa-circle text-success mr-1"></i>Active</td>
                                                    <td>
                                                    <a href="<?php echo base_url()?>/admin/profile" class="btn btn-success shadow btn-xs sharp"><i
                                                                class="fa fa-eye"></i></a>
